...
class RsEdition2018KeywordsAnnotator : RsAnnotatorBase() {
    override fun annotateInternal(element: PsiElement, holder: AnnotationHolder) {
        ...
        when {
            ...
            isEdition2018 && !isIdentifier && !isEnabledByCfg -> {
                val fileEditor = FileEditorManager.getInstance(element.project).selectedEditor
                val colorScheme = if (fileEditor is PsiAwareTextEditorImpl) {
                    fileEditor.editor.colorsScheme
                } else {
